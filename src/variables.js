const baseURL = 'https://flight-booking-cigs.herokuapp.com';

const airportStateNamesImp = [
  {
    IATA_code: 'IXC',
    ICAO_code: 'VICG',
...
const variables = { baseURL, airportStateNamesImp, airportStateNames };
